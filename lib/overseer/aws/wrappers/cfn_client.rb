require 'aws-sdk'
require 'json'
require 'overseer/aws/wrappers/s3_client'
    ...
    module Wrappers
      ...
      class CfnClient
        ...
        def handle_create_stack(create_output, exception)
          ...
          fail(OverseerError, fail_message)
        end
        ...
        def delete_stack(stack_name, options = {})
          ...
          s3_client = Overseer::AwsWrappers::S3Client.new
        ...
        def list_private_ips_in_stack(stack_name)
          ...
          instances.each_with_object([]) do |instance, collector|
            collector.push(
              Overseer::AwsWrappers::Ec2Client.new.instance_private_ip(instance)
            )
          end
        end
      end
